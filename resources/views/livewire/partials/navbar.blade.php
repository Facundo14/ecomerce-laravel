    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
      <div class="relative md:flex md:items-center md:justify-between">
        <div class="flex items-center justify-between">
          <img src="/assets/logo.png" alt="Logo Unión">
          <div class="md:hidden">
        ...
        <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
          <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
            <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
              ...
              <a wire:navigate class="font-medium text-xl {{ request()->is('/') ? 'text-green-600 dark:text-green-500' : 'text-gray-500' }} py-3 md:py-6 dark:hover:text-green-500  dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/" aria-current="page">Inicio</a>
  
              <a wire:navigate class="font-medium text-xl {{ request()->is('categories') ? 'text-green-600' : 'text-gray-500' }}  hover:text-green-400 py-3 md:py-6  dark:hover:text-green-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/categories">
                Categorias
              </a>
  
              <a wire:navigate class="font-medium text-xl {{ request()->is('products') ? 'text-green-600 dark:text-green-400' : 'text-gray-500' }} hover:text-green-400 py-3 md:py-6 dark:hover:text-green-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products">
                Productos
              </a>
              ...
              <div class="pt-3 md:pt-0">
                @livewire('partials.theme-toggle')
              </div>
